...
let pageTitle = formatMessage({ id: 'home:page_title', default: 'Value Link', description: 'The Home Page\'s title' });
let pageDescription = formatMessage({ id: 'home:page_description', default: 'This is the homepage of Value Link', description: 'The Home Page\'s description or Value Link\'s business motto' });
