...
let none = formatMessage({
    id: "concept: none",
    default: 'none',
    description: "The concept or idea of 'none', or 'zero'."
  })
...
let tableHeaders = {
  ...
  'dateAdded': formatMessage({
    id: "product:details_date_added",
    default: 'Date Added',
    description: "The table heading 'Date Added'"
  }),
  
  'tags': formatMessage({
    id: "product:details_tags",
    default: 'Tags',
    description: "The table heading 'Tags'"
  }),
  
  'type': formatMessage({
    id: "product:details_type",
    default: 'Type',
    description: "The table heading 'Type'. Type examples: 'desk' or 'sofa'."
  }),
      ...
      <div className={cx("product-images")}>
        {props.attrs.images.map((d, i) => {
          ...
          return <img 
            ...
            src={d.src} 
            alt={`Product Image of ${productImageAltText}`} />
        })}
      </div>
